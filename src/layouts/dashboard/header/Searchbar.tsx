import { Box, ClickAwayListener, InputAdornment, InputBase, Popper, PopperProps, Slide } from '@mui/material';
...
function Searchbar() {
    ...
    const reduceItems = NavConfig.map(list => handleLoop(list.items, (list as any).subheader)).flat();
